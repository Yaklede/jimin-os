export const copy = {
  ...
  conversations: {
    ...
    noTask: "열린 할 일이 없어요.",
    listTitle: "최근 요청",
    listDescription: "이전 요청을 이어서 볼 수 있어요.",
    ...
    userLabel: "나",
    composerLabel: "Jimin OS에 요청하기",
    composerPlaceholder: "예: 오늘 일정과 열린 할 일을 정리해 줘",
    composerHelp:
      "요청은 개인 서버에서 처리돼요. 연결한 정보는 실제로 사용할 때만 알려드려요.",
