...
export const copy = {
  ...
  decisions: {
    ...
    title: "판단함",
    description:
      "지민이 제안한 내용과 내가 내린 판단, 처리 결과를 한곳에서 확인해요.",
    pendingTitle: "확인이 필요한 제안",
    historyTitle: "처리한 제안",
    count: (count: number) => `${count}개`,
    emptyPendingTitle: "지금 확인할 제안이 없어요",
    emptyPendingDescription:
      "새로운 위험이나 기회를 찾으면 여기에 먼저 정리해 둘게요.",
    emptyHistoryTitle: "아직 처리한 제안이 없어요",
    emptyHistoryDescription: "제안을 확인하거나 미루면 처리 이력이 남아요.",
