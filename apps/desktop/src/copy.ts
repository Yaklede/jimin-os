export const copy = {
  ...
  home: {
    commandPlaceholder: "무엇을 도와드릴까요?",
    morningGreeting: "좋은 아침이에요",
    afternoonGreeting: "좋은 오후예요",
    eveningGreeting: "오늘도 수고했어요",
    title: "오늘을 같이 정리해 볼까요?",
    description: "지금 해야 할 일과 다음 일정을 한눈에 볼 수 있어요.",
    briefingLabel: "오늘의 브리핑",
    askAssistant: "비서에게 물어보기",
  ...
  conversations: {
    ...
    composerPlaceholder: "예: 오늘 해야 할 일을 우선순위대로 정리해 줘",
