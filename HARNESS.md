...
<!-- OPENDOCK:START id=files:HARNESS.md dock=opendock/interactive-ui-ultrawork path=HARNESS.md -->
...
<!-- OPENDOCK:END id=files:HARNESS.md dock=opendock/interactive-ui-ultrawork path=HARNESS.md -->
