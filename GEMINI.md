...
<!-- OPENDOCK:START id=files:GEMINI.md dock=opendock/korea-real-estate-research path=GEMINI.md -->
...
<!-- OPENDOCK:END id=files:GEMINI.md dock=opendock/korea-real-estate-research path=GEMINI.md -->

<!-- OPENDOCK:START id=files:GEMINI.md dock=opendock/korea-equity-research path=GEMINI.md -->
...
<!-- OPENDOCK:END id=files:GEMINI.md dock=opendock/korea-equity-research path=GEMINI.md -->

<!-- OPENDOCK:START id=files:GEMINI.md dock=opendock/korea-macro-research path=GEMINI.md -->
...
<!-- OPENDOCK:END id=files:GEMINI.md dock=opendock/korea-macro-research path=GEMINI.md -->
