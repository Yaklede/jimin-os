...
8. Review those target files against the design contract, reference planning, palette planning, Create UI component decisions, semantic token plan, StyleSeed coherence, accessibility basics, and hard quality checklist.
